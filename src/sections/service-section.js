...
import ServiceThumb from 'assets/amandapastel.jpeg';
  ...
  features: [
    {
      ...
      text:
        'I do not deliver but I have pop-up shops all over orange county! Follow my Instagram for more details.',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      title: 'Learn More',
      text:
        'Discover the history and background behind my paintings.',
    },
  ],
};
            ...
            {data.features.map((feature)=>(
              <Box sx={styles.card} key={feature.id}>
                ...
                <Box sx={styles.wrapper}>
                  ...
                  <Text sx={styles.wrapper.subTitle}>{feature.text}
                  </Text>
